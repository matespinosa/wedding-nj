      ...
      <div className="section-container">
        ...
        <div className="details-grid">
          ...
          >
            ...
            <h3>Fecha y Hora</h3>
            <p>Viernes, 24 de Abril</p>
            <p className="detail-sub">2026 · 7:00 PM</p>
          </Reveal>
          ...
          >
            ...
            <h3>Ceremonia</h3>
            <p>7:00 PM</p>
            <p className="detail-sub">Seguida de recepcion</p>
          </Reveal>
          ...
          >
            ...
            <h3>Ubicacion</h3>
            <p>Maddy Rose Restaurant at Liberty House</p>
            <p className="detail-sub">76 Audrey Zapp Dr Floor 1, Jersey City, NJ 07305</p>
            <a
