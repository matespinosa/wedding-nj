...
const translations = {
  es: {
    hero: {
      ...
      sec: 'Seg',
      scrollLabel: 'Scroll',
      scrollAria: 'Desplázate hacia abajo para ver el formulario de confirmación de asistencia',
    },
    details: {
  ...
  en: {
    hero: {
      ...
      sec: 'Sec',
      scrollLabel: 'Scroll',
      scrollAria: 'Scroll down to the RSVP form',
    },
    details: {
